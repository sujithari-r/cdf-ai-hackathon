...
//       systemSizeKw * 8760 * (capFactor / 100);
...
//   const activeMetrics =
//     rateMode === "map" ? mapMetrics : manualMetrics;
...
//         <h1 className="text-3xl font-bold">Project Economics Calculator</h1>
...
//       {selectedLocation && (
//         <section className="p-4 border rounded-xl shadow-sm bg-green-50">
//           <h2 className="text-lg font-semibold">Using Map Selection</h2>
...
//         <section className="p-6 border rounded-xl shadow-sm space-y-4">
...
//             <select
//               value={scenario}
//               onChange={(e) => setScenario(e.target.value as "base" | "optimistic")}
...
//             Active Scenario: {scenario === "base" ? "Base Case" : "Optimistic Case"}
//           </p>

//           <div className="mt-2 p-3 rounded-lg border border-green-300 bg-green-50">
...
//               ${totalProjectCost.toLocaleString("en-US")}
//             </p>
//           </div>

//           <div>
//             <p className="text-sm text-gray-500">Annual Energy Production</p>
//             <p className="text-2xl font-bold">
...
//           <div>
//             <p className="text-sm text-gray-500">Annual Operating Cost</p>
//             <p className="text-2xl font-bold">
...
//             <p className="text-2xl font-bold">
//               ${netOperatingIncome.toLocaleString("en-US")}
//             </p>
//           </div>

//           <div>
//             <p className="text-sm text-gray-500">Simple Payback Period</p>
//             <p className="text-2xl font-bold">
//               {paybackPeriod ? `${paybackPeriod.toFixed(1)} years` : "Not achievable"}
//             </p>
//           </div>

//           <div>
//             <p className="text-sm text-gray-500">NPV (20 years, 8% discount)</p>
//             <p className="text-2xl font-bold">
...
//             <h2 className="text-xl font-semibold mb-4">Manual Rate Results</h2>
//             <div className="space-y-3">
//               <p className="text-sm text-gray-600">
//                 Rate Used: ${manualRateForScenario.toFixed(3)}/kWh
//               </p>
//               <p>
...
//           <div className="p-6 border rounded-xl shadow-sm bg-white">
//             <h2 className="text-xl font-semibold mb-4">Map Rate Results</h2>
//             <div className="space-y-3">
//               <p className="text-sm text-gray-600">
//                 Rate Used: ${mapRateForScenario.toFixed(3)}/kWh
//                 {selectedLocation ? ` from ${selectedLocation.name}` : " (fallback/manual)"}
//               </p>
//               <p>
//                 <span className="text-gray-500">Annual Revenue:</span>{" "}
//                 <span className="font-semibold">
