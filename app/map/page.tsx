...
//   return (
//     <main className="min-h-screen bg-gradient-to-b from-white to-gray-50 px-6 py-10 md:px-10 space-y-8">
//       <section className="rounded-3xl border bg-white shadow-sm p-8 md:p-10">
//         <div className="space-y-3">
//           <div className="inline-flex rounded-full border bg-gray-50 px-3 py-1 text-sm text-gray-600">
//             Geographic Insights
//           </div>

//           <h1 className="text-4xl font-bold tracking-tight">
//             Renewable Energy Location Map
//           </h1>

//           <p className="text-gray-600 max-w-3xl text-lg">
//             Compare state-level renewable opportunity signals and select a
//             location to use map-based electricity pricing in the calculator.
//           </p>
//         </div>
//       </section>

//       {message === "select-location" && (
//         <section className="rounded-2xl border border-yellow-300 bg-yellow-50 p-4 shadow-sm">
...
//                 {selectedLocation.name} — Electricity Rate: $
//                 {selectedLocation.electricityRate}/kWh, Solar Score:{" "}
//                 {selectedLocation.solarScore}/10
//               </p>
//             </div>

//             <div className="inline-flex rounded-full bg-white px-3 py-1 text-xs text-gray-600 border w-fit">
...
//             <p className="text-sm text-gray-500">How to use this map</p>
//             <h2 className="text-xl font-semibold mt-2">
//               Select a state to drive pricing assumptions
//             </h2>
//             <p className="text-gray-600 leading-7 mt-4">
//               Clicking a marker updates the shared dashboard context. The
//               selected location’s electricity rate can then be used inside the
//               calculator or compared against manual assumptions.
//             </p>
//           </section>

//           <section className="rounded-2xl border bg-black text-white p-6 shadow-sm">
//             <p className="text-sm text-gray-300">What the markers represent</p>
//             <h2 className="text-xl font-semibold mt-2">
//               Opportunity-focused location data
//             </h2>
//             <p className="text-gray-300 leading-7 mt-4">
//               Each marker includes a dashboard electricity rate, a solar score,
//               and a short qualitative note to help compare market attractiveness
//               across locations.
//             </p>
//           </section>

//           <section className="rounded-2xl border bg-white p-6 shadow-sm">
//             <p className="text-sm text-gray-500">Tracked Locations</p>
...
//                   </p>
//                   <p className="text-sm text-gray-600 mt-1">{location.note}</p>
//                 </button>
//               ))}
//             </div>
//           </section>
